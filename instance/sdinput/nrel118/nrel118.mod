...
table bus_data IN "CSV" "../../energySystems//nrel118/busData.csv" : 
...
table lines_data IN "CSV" "../../energySystems//nrel118/lineData.csv" : 
...
table gen_data IN "CSV" "../../energySystems//nrel118/genData.csv" : 
...
table renew_data IN "CSV" "../../energySystems//nrel118/renewData.csv" : 
...
table load_data IN "CSV" "../../energySystems//nrel118/loadData.csv" : 
...
table realLoad_data IN "CSV" "../../energySystems//nrel118/realLoad_glpk.csv" :
D <- [Period,Region], realLoad;
# param realLoad < read("../../energySystems//nrel118/realLoad_glpk.csv":

set W, dimen 2;
param renewPower{W};
table renewPower_data IN "CSV" "../../energySystems//nrel118/renewPower_glpk.csv" :
